...
### Контроллеры
-  ✔️ СДЕЛАНО ✔️  Зарефакторить ReportController.php
...
- Функционал
    ...
    - Сделать мульти загрузку отчётов -> Сделать мульти добавление ID компьютеров (а не мульти загрузку отчётов)
    ...
    -  ✔️ СДЕЛАНО ✔️  Изменен парсер под новые требования.
    -  || ЧАСТИЧНО ||  Изменены контроллеры под новые требования.
    -  ✔️ СДЕЛАНО ✔️  Добавлена промежуточная таблица между Идентификаторами уяз-стей и самими уязвимостями.
    -  ✔️ СДЕЛАНО ✔️  Исправить 500 ошибку, когда не было данных в БД о последней базе уяз-стей. 
    - Добавить таблицу с "Ссылками на файлы" и промежуточную таблицу.
